...
if(isset($_POST['sub']))
{
    ...
    $zz=  mysqli_query($dbcon,"insert into msg values('','$usr','$mid','$t1','$date','$tim','1')");
    if($zz>0)
    {
...
<!--            <script>
    ...
    $pr1=mysqli_fetch_row($pr);
            ...
            <div class="incoming_msg">
              <div class="incoming_msg_img"> <img style="width: 100px;height: 53px;" class="img img-circle" src="../img5/<?php echo $pr1[8] ?>" alt="sunil"> </div>
          ...
          <div class="type_msg">
            <div class="input_msg_write">
              <input type="text" name="t1" class="write_msg" placeholder="Type a message" />
              <button class="msg_send_btn" name="sub" type="submit"><i class="fa fa-paper-plane-o" aria-hidden="true"></i></button>
            </div>
          </div>
            </form>
          </div>
