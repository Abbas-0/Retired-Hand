...
<div class="matches elite-app">
	...
	<div class="tittle-agileinfo">
		<h3>Service Enquiry</h3>
         ...
         <?php
                                                        ...
                                                        $sel1=mysqli_query($dbcon,"select * from req where st='0' and uid='$usr'");
	...
	<div class="matches-main-agileinfo">
		...
		<div class="about-person">
                    <div class="sim-button button12"><a href="com_dt.php?mid=<?php echo $r_gal[6] ?>">Company Details</a></div>
		</div>
	</div>
	<?php
                                                            }
