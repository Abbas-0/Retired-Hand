...
<div class="matches elite-app">
	...
	<div class="tittle-agileinfo">
		<h3>Retired Service</h3>
         ...
         <?php
                                                        ...
                                                        $sel1=mysqli_query($dbcon,"select * from req where st='1' and cid='$usr' and st_dt <= '$date' and end_dt >= '$date' order by id desc");
    ...
    $r2=  mysqli_num_rows($sel2);
		...
		<div class="about-person">
                    <div class="sim-button button12"><a href="user_dt.php?mid=<?php echo $r_gal[11] ?>">His Details</a></div>&nbsp;&nbsp;<div class="sim-button button12"><a href="staff1.php?mid=<?php echo $r1[0] ?>">Assign Staffs</a></div> &nbsp;&nbsp;<div class="sim-button button12"><a href="chat.php?mid=<?php echo $r1[0] ?>">View Chat</a></div>
		</div>
	</div>
	<?php
                                                            }
