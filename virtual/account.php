...
<html>
<head>
<title>Furnyish Store a Ecommerce Category Flat Bootstarp Responsive Website Template | Account :: Trinity Technologies</title>
...
<div class="container">
	 ...
	 <div class="registration">
		 <div class="registration_left">
			 ...
			 <div class="registration_form"action="login.php">
                             
                              <?php
                            
if(isset($_POST['b1']))
{
mysql_query("insert into reg_bank(name,email,mobile,gender,password,re_password)values('$_POST[t1]','$_POST[t2]','$_POST[t3]','$_POST[r1]','$_POST[t4]','$_POST[t5]')")or die(mysql_error());
...
?>
			 <!-- Form -->
				<form id="registration_form" method="post">
					<div>
						<label>
							<input placeholder="Name:" type="text" name="t1"tabindex="1" required autofocus>
						</label>
					</div>
					
					<div>
						<label>
							<input placeholder="email address:" type="email" tabindex="3"name="t2" required>
						</label>
					</div>
					<div>
						<label>
                                                    <input placeholder="Mobile:" type="text" tabindex="3"name="t3" required>
						</label>
					</div>					
						<div class="sky_form1">
							<ul>
								<li><label class="radio left"><input type="radio" name="r1"><i></i>Male</label></li>
								<li><label class="radio"><input type="radio" name="r1"><i></i>Female</label></li>
								<div class="clearfix"></div>
							</ul>
						</div>					
					<div>
						<label>
							<input placeholder="password" type="password" tabindex="4"name="t4" required>
						</label>
					</div>						
					<div>
						<label>
							<input placeholder="retype password" type="password" tabindex="4"name="t5" required>
						</label>
					</div>	
					<div>
						<input type="submit" value="create an account"name="b1">
					</div>
...
if(isset($_POST['b2']))
{
mysql_query("select * from reg_bank where email='$_POST[l1]' and password='$_POST[l2]'");
if(mysql_affected_rows()>0)
{
...
?>
					<div>
						<label>
							<input placeholder="email:"name="l1" type="email" >
						</label>
					</div>
					<div>
						<label>
							<input placeholder="password"name="l2" type="password">
						</label>
					</div>						
					<div>
						<input type="submit"name="b2" value="sign in" id="register-submit">
					</div>
					<div class="forget">
