	...
	<div class="tittle-agileinfo">
		<h3>Company Enquiry</h3>
         ...
         <?php
                                                        ...
                                                        $sel_gal=mysqli_query($dbcon,"select * from com_data where st='0'");
	...
	<div class="matches-main-agileinfo">
		...
		<div class="col-md-6 person-info-agileits-w3layouts">
			<ul>
				...
				<li><span>Established on</span>: <?php echo $r_gal[4] ?></li>
		...
		<div class="about-person">
			...
			<p class="para-agileits-w3layouts"><span>Hi!, we are <?php echo $r_gal[1] ?> </span><?php echo substr($r_gal[3],0,200)?>.....</p>
                        <div class="sim-button button12"><a href="enq_dt1.php?mid=<?php echo $r_gal[6] ?>">Read More</a></div>
		</div>
	</div>
	<?php
                                                            }
