...
if(isset($_GET['upd']))
{
    $uid=$_GET['uid'];  
    $upd=$_GET['upd'];
    $upd1=mysqli_query($dbcon,"update user_data set st='1' where id='$upd'");
...
if(isset($_GET['del']))
{
    $uid=$_GET['uid'];  
    $upd=$_GET['del'];
    $upd1=mysqli_query($dbcon,"update user_data set st='2' where id='$upd'");
	...
	<div class="matches-main-agileinfo">
		...
		<div class="about-person">
			<h6>About Myself:</h6>
                        ...
                        <br/>
                        <div class="btn btn-success"><a href="enq_dt.php?upd=<?php echo $r[0] ?>&uid=<?php echo $r[11] ?>"><b style="color: white">Approve</b></a></div>&nbsp;&nbsp;<div class="btn btn-danger"><a href="enq_dt.php?del=<?php echo $r[0] ?>&uid=<?php echo $r[11] ?>"><b style="color: white">Reject</b></a></div>
		</div>
	</div>
