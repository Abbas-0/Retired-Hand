...
<div class="matches elite-app">
	...
	<div class="tittle-agileinfo">
		<h3>Retired Help Service</h3>
	</div>
         <?php
         $mid=$_GET['mid'];
                        
                                                        $sel_gal=mysqli_query($dbcon,"select * from user_data where st='1' and pro='$mid'");
                                                        while($r_gal=mysqli_fetch_row($sel_gal))
                                                            {
                                                        ?>   
	<div class="matches-main-agileinfo">
		<div class="col-md-6 profile1"> 
                    <img style="width: 245px;height: 325px" src="../img1/<?php echo $r_gal[14] ?>">
		</div>
		<div class="col-md-6 person-info-agileits-w3layouts">
			<ul>
				...
				<li><span>Profession</span>: 
                                <?php
                                $cat=mysqli_query($dbcon,"select * from cate where id='$r_gal[6]'");
                                $cat1=mysqli_fetch_row($cat);
                                echo"$cat1[2]";
                                ?>
                                </li>
				<li><span>Experience</span>: <?php echo $r_gal[7] ?> Years</li>
				<li><span>Company</span>: <?php echo $r_gal[8] ?>(<?php echo $r_gal[9] ?>)</li>
				<li><span>Contact</span>: <?php echo $r_gal[10] ?></li>
                                <li><span>Fee</span>: <b><?php echo $r_gal[17] ?> Rs/- (1 day per head)</b></li>
                                <li><a href="../img2/<?php echo $r_gal[15] ?>">Download Info <div class="fa fa-download"></div></a></li>
			</ul>
		</div>
		<div class="clearfix"> </div>
		<div class="about-person">
			<h6>About Myself:</h6>
			<p class="para-agileits-w3layouts"><span>Hi!, I am <?php echo $r_gal[1] ?> </span><?php echo substr($r_gal[4],0,200)?>.....</p>
                        <div class="sim-button button12"><a href="user_dt.php?mid=<?php echo $r_gal[11] ?>">Read More</a></div>
		</div>
	</div>
	<?php
                                                            }
