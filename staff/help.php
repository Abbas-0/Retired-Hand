...
session_start();
$usr=$_SESSION['uid'];
$sel2=mysqli_query($dbcon,"select * from staff_data where em='$usr'");
...
<div class="matches elite-app">
	...
	<div class="tittle-agileinfo">
		<h3>Retired Service</h3>
	</div>
         <?php
                        
                                                        $sel1=mysqli_query($dbcon,"select * from req where st='1' and cid='$r2[9]' and st_dt <= '$date' and end_dt >= '$date' order by id desc");
                                                        while($r1=mysqli_fetch_row($sel1))
                                                        {
                                                                $sel_gal=mysqli_query($dbcon,"select * from user_data where em='$r1[8]'");
	...
	<div class="matches-main-agileinfo">
		...
		<div class="col-md-6 person-info-agileits-w3layouts">
			<ul>
                            <li><span>Company Name</span>: <?php echo $r_gal[1] ?></li>
    ...
    $r2=  mysqli_num_rows($sel2);
		...
		<div class="about-person">
                    <div class="sim-button button12"><a href="user_dt.php?mid=<?php echo $r_gal[11] ?>">His Details</a></div>
                    <?php
                    
                    $log=mysqli_query($dbcon,"select * from assi where rid='$r1[0]' and sid='$usr'");
if(mysqli_num_rows($log)>0)
{
                    ?>
                    &nbsp;&nbsp;<div class="sim-button button12"><a href="chat.php?mid=<?php echo $r1[0] ?>">Start Chat</a></div>
