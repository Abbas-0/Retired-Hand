...
<html>
<head>
<title>Furnyish Store a Ecommerce Category Flat Bootstarp Responsive Website Template | Login :: Trinity Technologies</title>
...
if(isset($_POST['b2']))
{
mysql_query("select * from reg_bank where email='$_POST[t1]' and password='$_POST[t2]'");
