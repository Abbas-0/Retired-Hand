...
if(mysqli_num_rows($log1)>0)
{
 header("location:reg.php?fail=1");   
    ...
    $log=mysqli_query($dbcon,"select * from account_bank where account_no='$t13' ");
if(mysqli_num_rows($log)>0)
{
    ...
    {
    $ins=mysqli_query($dbcon,"insert into user_data values('','$t1','$t2','$t3','$t4','$t5','$t6','$t7','$t8','$t9','$t10','$t11','$t12','$t13','$nfn','$nfn1','0','$ta')");
    
    if($ins>0)
    {
      $ins1=mysqli_query($dbcon,"insert into user_log values('','$t11','$t12','usr','0')");
        if($ins1>0)
        {
...
<div class="login elite-app">
	...
	<div class="col-md-8 login-form-w3-agile">
			<form  method="post" enctype="multipart/form-data">
				...
				<div class="w3_form_body_grid w3_form_body_grid1">
					...
					<span>About Me</span>
                                        ...
                                        <textarea name="t4" class="frm-field required"></textarea>
                                </div>
				<div class="w3_form_body_grid">
                                    <span>Job Type</span>
					<select name="t5" class="frm-field required"onchange="loaddistrict(this.value);loadst_hos(this.value)">
					...
					<span>Profession</span>
                                        <div id="dis">
					<select name="t6" class="frm-field required">
				...
				<div class="w3_form_body_grid w3_form_body_grid1">
					...
					<input type="text" name="t7" placeholder="Years of Experiance" required="">
				</div>
                               <div class="w3_form_body_grid w3_form_body_grid1">
					<span>Company</span>
					<input type="text" name="t8" placeholder="Last Company worked For" required="">
				</div>
                               <div class="w3_form_body_grid w3_form_body_grid1">
					<span>Worked As</span>
					<input type="text" name="t9" placeholder="Previous Job Status" required="">
				</div>
                               <div class="w3_form_body_grid w3_form_body_grid1">
					<span>Fee</span>
                                        <input type="text" name="ta" placeholder="1 day per head" required="">
				</div>
                              <div class="w3_form_body_grid w3_form_body_grid1">
					<span>Contact</span>
                                        <input type="text" name="t10" placeholder="Contact Info" required="">
				</div>
				<div class="w3_form_body_grid">
					<span>Email</span>
                                        <input type="email" name="t11" placeholder="Email" required="">
				</div>
				<div class="w3_form_body_grid w3_form_body_grid1">
					<span>Password</span>
					<input type="password" name="t12" placeholder="Password" required="">
				</div>
                               <div class="w3_form_body_grid">
					<span>Account no</span>
					<input type="text" name="t13" placeholder="Your Account number" required="">
				</div>
                               <div class="w3_form_body_grid w3_form_body_grid1">
            ...
            <div class="col-md-4 login-right-info">
                ...
                <img style="width: 100%;height: 290px" src="pic/f8a7e5314432eaf452e29fca9fd36ed0.jpg">
            </div>
            <div class="col-md-4 login-right-info right-info-find">
                
                <img style="width: 100%;height: 270px" src="pic/1395879440-how-hire-someone-aligned-company-mission.jpg">
            </div>
            <div class="col-md-4 login-right-info right-info-find">
                
                <img style="width: 100%;height: 270px" src="pic/vG1j5x.jpg">
            </div>
	</div>
</div>
<!--login-inner-->
